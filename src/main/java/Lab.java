...
public class Lab {
    ...
    public Deque<String> createNewStack(){
        ArrayDeque<String> stack = new ArrayDeque<>(); // when declaring, got to make sure to include the arguments inside of <>. for some reason (not fully clear to me yet) args are not needed after "new"
        return stack;
    }
